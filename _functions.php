...
function add_kary($karyawan){
	...
	$insert = "INSERT INTO master (nama, username, email, password, level) VALUES ('$nama','$email','$username','$password','$level')";
...
function add_ck($data_ck){
	...
	$query_ck = "INSERT INTO tb_cuci_komplit (nama_paket_ck, waktu_kerja_ck, kuantitas_ck, tarif_ck) VALUES ('$nama_pkt_ck','$waktu_krj_ck','$qty_ck','$tarif_ck'
	)";
...
function add_dc($data_dc){
	...
	$query_dc = "INSERT INTO tb_dry_clean (nama_paket_dc, waktu_kerja_dc, kuantitas_dc, tarif_dc) VALUES ('$nama_pkt_dc','$waktu_krj_dc','$qty_dc','$tarif_dc')";
...
function add_cs($data_cs){
	...
	$query_cs = "INSERT INTO tb_cuci_satuan (nama_cs, waktu_kerja_cs, kuantitas_cs, tarif_cs, keterangan_cs) VALUES ('$nama_pkt_cs','$waktu_krj_cs','$qty_cs','$tarif_cs','$ket_cs'
	)";
...
function order_ck($order_ck){
	...
	$insert_ck = "INSERT INTO tb_order_ck VALUES( 
		NULL,'$orderNum','$nama_pel','$no_telp','$alamat',
...
function order_dc($order_dc){
	...
	$query_dc = "INSERT INTO tb_order_dc VALUES (
		NULL,'$orderNum_dc','$nama_pel_dc','$no_telp','$alamat_dc','$jns_paket','$wkt_kerja_dc',
...
function order_cs($order_cs){
	...
	$query_cs = "INSERT INTO tb_order_cs VALUES (
		NULL,'$orderNum_cs','$nama_pel_cs','$no_telp_cs','$alamat_cs','$jenis_pkt_cs',
...
function transaksi_ck($trans_ck){
	...
	$nominal_bayar = htmlspecialchars($trans_ck['nominal_bayar']);
	...
	// $query_insert_ck = "INSERT INTO tb_riwayat_ck (
	// 	or_number, pelanggan, no_telp, alamat, j_paket, wkt_kerja, berat, h_perkilo, tgl_msk, tgl_klr, total, keterangan, nominal_byr) VALUES (
	// 	'$or_number','$pelanggan','$no_telp','$alamat','$jns_paket','$wkt_kerja','$berat','$h_perkilo','$tgl_msk','$tgl_klr','$total','$keterangan','$nominal_bayar','$kembalian','$status'
	// )";

	$query_insert_ck = "INSERT INTO `tb_riwayat_ck` (`id_ck`, `or_number`, `pelanggan`, `no_telp`, `alamat`, `j_paket`, `wkt_kerja`, `berat`, `h_perkilo`, `tgl_msk`, `tgl_klr`, `total`, `nominal_byr`, `kembalian`, `status`, `keterangan`) VALUES (NULL, '$or_number', '$pelanggan', '$no_telp', '$alamat', '$jns_paket', '$wkt_kerja', '$berat', '$h_perkilo', '$tgl_msk', '$tgl_klr', '$total', '$nominal_bayar', '$kembalian', '$status', '$keterangan')";
...
function transaksi_cs($trans_cs){
	...
	// $query_insert_cs = "INSERT INTO tb_riwayat_cs (or_number, pelanggan, no_telp, alamat, j_paket, wkt_kerja, jml_pcs, h_perpcs, tgl_msk, tgl_klr, total, keterangan, nominal_byr) VALUES (
	// 	'$or_number',
	// 	'$pelanggan',
	// 	'$no_telp',
	// 	'$alamat',
	...
	$query_insert_cs = "INSERT INTO `tb_riwayat_cs` (`id_cs`, `or_number`, `pelanggan`, `no_telp`, `alamat`, `j_paket`, `wkt_kerja`, `jml_pcs`, `h_perpcs`, `tgl_msk`, `tgl_klr`, `total`, `nominal_byr`, `kembalian`, `status`, `keterangan`) VALUES (NULL, '$or_number', '$pelanggan', '$no_telp', '$alamat', '$jns_paket', '$wkt_kerja', '$jml_pcs', '$h_perpcs', '$tgl_msk', '$tgl_klr', '$total', '$nominal_bayar', '$kembalian', '$status', '$keterangan')";
